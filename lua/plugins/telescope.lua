return {
  ...
  config = function()
    ...
    keymap.set("n", "<leader>fd", "<cmd>Telescope diagnostics bufnr=0<cr>", { desc = "Find diagnostics in current buffer" })
    keymap.set("n", "<leader>fe", "<cmd>Telescope diagnostics<cr>", { desc = "Find diagnostics in workspace" })
  end,
}
